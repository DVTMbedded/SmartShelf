...
{
	const char local_name[] = {AD_TYPE_COMPLETE_LOCAL_NAME, BLE_DEVICE_NAME};

	uint8_t manuf_data[16] = {
			2, 0x0A, 0x00, /* 0 dBm */ // Trasmission Power
			12, 0x09, BLE_DEVICE_NAME, // Complete Name
	};

	hci_le_set_scan_resp_data(0, NULL);

	aci_gap_set_discoverable(ADV_DATA_TYPE,
