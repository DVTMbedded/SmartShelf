...
#ifndef __STM32L5XX_NUCLEO_H
#define __STM32L5XX_NUCLEO_H
...
/** @defgroup STM32L5XX_NUCLEO
 * @{
 */

/** @defgroup STM32L5XX_NUCLEO_LOW_LEVEL
 * @{
 */
...
/** @defgroup STM32L4XX_NUCLEO_LOW_LEVEL_Exported_Constants LOW LEVEL Exported Constants
  ...
  */
/**
 * @brief STM32L5XX NUCLEO BSP Driver version number V1.0.0
 */
#define __STM32L5XX_NUCLEO_BSP_VERSION_MAIN   (uint32_t)(0x01) /*!< [31:24] main version */
#define __STM32L5XX_NUCLEO_BSP_VERSION_SUB1   (uint32_t)(0x00) /*!< [23:16] sub1 version */
#define __STM32L5XX_NUCLEO_BSP_VERSION_SUB2   (uint32_t)(0x00) /*!< [15:8]  sub2 version */
#define __STM32L5XX_NUCLEO_BSP_VERSION_RC     (uint32_t)(0x00) /*!< [7:0]  release candidate */
#define __STM32L5XX_NUCLEO_BSP_VERSION        ((__STM32L5XX_NUCLEO_BSP_VERSION_MAIN << 24)\
                                                    |(__STM32L5XX_NUCLEO_BSP_VERSION_SUB1 << 16)\
                                                    |(__STM32L5XX_NUCLEO_BSP_VERSION_SUB2 << 8 )\
                                                    |(__STM32L5XX_NUCLEO_BSP_VERSION_RC))

/** @defgroup STM32L5XX_NUCLEO_LOW_LEVEL_Exported_Types STM32L5XX_NUCLEO LOW LEVEL Exported Types
 * @{
 */

 /**
  * @brief Define for STM32L5XX_NUCLEO board
  */
#if !defined (USE_STM32L5XX_NUCLEO)
...
/** @defgroup STM32L5XX_NUCLEO_LOW_LEVEL_LED STM32L5XX_NUCLEO LOW LEVEL LED
 * @{
 */
...
/** @defgroup STM32L5XX_NUCLEO_LOW_LEVEL_BUTTON STM32L5XX_NUCLEO LOW LEVEL BUTTON
 * @{
 */
/* Button state */
 ...
 * @}
 */
/** @defgroup STM32L5XX_NUCLEO_LOW_LEVEL_COM STM32L5XX_NUCLEO LOW LEVEL COM
 * @{
 */
/**
...
/** @defgroup STM32L5XX_NUCLEO_LOW_LEVEL_Exported_Types LOW LEVEL Exported Types
  * @{
  */
#ifndef USE_BSP_COM
...
/** @defgroup STM32L5XX_NUCLEO_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Constants
  * @{
  */
...
/** @defgroup STM32L5XX_NUCLEO_LOW_LEVEL_Exported_Functions STM32L5XX_NUCLEO LOW LEVEL Exported Functions
 * @{
 */
